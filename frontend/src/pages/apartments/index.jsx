...
import ApartmentCard from '../../components/apartments/list/ApartmentCard';
import LoadingIndicator from '../../components/common/LoadingIndicator';
import ErrorMessage from '../../components/common/ErrorMessage';
import SearchFilters from '../../components/apartments/list/SearchFilters';
import BrowseApartmentsHeader from '../../components/apartments/list/BrowseApartmentsHeader';
import NoApartmentsFound from '../../components/apartments/list/NoApartmentsFound';
import ResultsCounter from '../../components/apartments/list/ResultsCounter';
...
const ApartmentsListPage = () => {
  ...
  const handleFilterChange = (newFilters) => {
    // Ensure all filter values are defined strings
    const safeFilters = {
      unitNumber: newFilters.unitNumber || '',
      unitName: newFilters.unitName || '',
